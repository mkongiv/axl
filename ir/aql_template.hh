...
#ifndef AQCL_TEMPLATE
#define AQCL_TEMPLATE
...
class aqcl_template : public aqcl_node
{

  public:

  aqcl_template () : aqcl_node ()
  {
  ...
  {
    assert (0 && "Method generated from aql_template.hh. Must implement in new class.");
  }
